...
KEYWORDS = [
  'Sajak', #untuk definisi VARIABEL
  'Dan', #untuk definisi AND
  'Atau', #untuk definisi OR
  'Tidak', #untuk definisi NOT
  'Ketika', #untuk definisi IF
  'Lain_jika', #untuk definisi ELIF
  'Lain', #untuk definisi ELSE
  'Untuk', #untuk definisi FOR
  'Ke', #untuk definisi TO
  'Langkah', #untuk definisi STEP
  'Sedangkan', #untuk definisi WHILE
  'Fungsi', #untuk definisi FUN (Funtion)
  'Maka' #untuk definisi THEN
]
